...
(
	function()
	{
		var intervalFunction=null;						//global pointer to control timing events
		...
		function startService()
		{
			...
			interval*=1000;
			intervalFunction=setInterval(function(){updateDisplay()},interval);	
		...
		function User(details,event)
		{
			...
			this.toHTMLListItem=function()
			{
				...
				html+="<span class='ul-li-count'>"+this.events.length+"</span>";
				html+="</li>";
				return html;
			};
			this.display=function()
